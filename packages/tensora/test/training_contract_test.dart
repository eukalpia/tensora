...
void main() {
  ...
  test('core tensors report no autograd and training transforms fail clearly', () {
  ...
  test('disabled losses return structured unsupported errors without leaks', () {
  ...
  test('internal native adoption capability cannot be guessed', () {
    ...
    expect(
      () => tensor.nativeHandleForRuntime(Object()),
      throwsStateError,
    );
    expect(

...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(
        () =>
            optim.Adam.groups(groups: const <optim.ParameterGroup>[], beta1: 1),
        throwsArgumentError,
      );
      expect(
        () => optim.Adam.groups(
      ...
      expect(
        () =>
            optim.ParameterGroup(parameters: <Parameter>[parameter, parameter]),
        throwsArgumentError,
      );
      expect(
      ...
      expect(
        () =>
            optim.ParameterGroup(parameters: <Parameter>[parameter], beta1: 1),
        throwsArgumentError,
      );
      expect(
        () => optim.ParameterGroup(
